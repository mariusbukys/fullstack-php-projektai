...
if (isset($_GET['dir']) and $_GET['dir'] != '') {
    ...
    if ($dir != './') {
        ...
        $back_link = '<tr>
                            <td colspan="3"><a href="?dir=' . $back_link . '">Back to parent directory</a></td>
                        </tr>';
    }
}
...
<body class="">
    ...
    <div class="text-center"><h1>File Manager</h1></div>
        <?php if(isset($_GET['m']) AND $_GET['m'] != '') { ?>
            <div class="alert alert-danger">
                <?= $_GET['m'] ?>
            </div>
        <?php } ?>
        <table class="table bg-secondary border border-secondary">
            <thead>
                <tr class="text-white">
                    <th>Name</th>
                    <th>Date created</th>
            ...
            <tbody>
                ...
                ?>
                    <tr class="text-black bg-body-secondary p-3">
                        ...
                        <td><?=date("Y-m-d")?></td>
                        <td>
                            <a href="?edit=<?= $path ?>&dir=<?= $dir ?>" class="btn btn-dark"><i class="bi bi-pencil"></i></a>
                            <a href="?delete=<?= $path ?>&dir=<?= $dir ?>" class="btn btn-dark"><i class="bi bi-trash3"></i></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
        ...
        <?php if(isset($_GET['edit'])) { ?>
            ...
            <form class="w-50" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="file_name_edited" class="form-control"  value="<?= $_GET['edit'] ?>" />
                </div>
