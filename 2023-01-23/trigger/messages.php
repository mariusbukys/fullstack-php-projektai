...
<body class="">
    ...
    <div class="container pb-5 pt-0 bg-light border border-dark-subtle">

   
   <div class="text-end pt-4">
   
   <a href="./login.php" class="btn bg-info"><i class="bi bi-power"></i>Atsijungti</a>
   </div>
  ...
  <div class=" p-5 bg-opacity-75 bg-secondary bg-gradient container w-75 mb-4">
    
    <div class="d-flex bg-dark bg-gradient rounded-top p-3 ">
     
        <img class="w-25 me-3 border-white rounded-circle" src="./userphoto/<?=$_SESSION['user']['user-photo'] ?>" />
    ...
    <div class=" ">
  <div class="bg-dark  justify-content-center p-3 d-flex mx-6 mb-3">
  ...
  <?php endif; ?>
   ...
   <button class="btn bg-info" type="submit" >Rasyti komentara</button>
    </form>
    </div>
</div>
  ...
  <div class="d-flex justify-content-center">
   <div class="w-75  ">
    ...
    <div class="card mb-3 pb-3">
        ...
        <p class="fs-4 fw-bold mb-0 pt-2" ><?=$user['name']?></p>
        <p class="mb-0 pt-3"><?=$user['created']?></p>
       </div>
    </div>
        <div class="card-body  ">
            <?php if(isset($user['image'])) : ?>
                <div class="d-flex bg-secondary rounded py-3 mb-3 justify-content-center">
